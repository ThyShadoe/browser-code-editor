...
$("#openPreview")?.addEventListener("click", () => {
  ...
  w.document.close(); // Close window to prevent resource hogging.
});
...
function loadProject(obj) {
  try {
    ...
    ed.html.setValue(obj.html || "", -1);

    ed.css.setValue(obj.css || "", -1);

    ed.js.setValue(obj.js || "", -1);

    log("Web Project Loaded.");
  } catch (e) {
    log("Unable to load this Project: " + e, "error");
  }
}

function setDefaultContent() {
  ed_html.setValue(`<!-- Write HTML Code here... -->`, -1);
  ed_css.setValue(`/* Write CSS Code here... */`, -1);
  ed_js.setValue(`// Write JavaScript Code here... `, -1);
}
